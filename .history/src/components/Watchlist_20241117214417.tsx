...
export const Watchlist = () => {
    ...
    const fetchWatchlist = async () => {
        try {
            const response = await fetch('http://localhost:000/api/watchlist');
            if (!response.ok) {
    ...
    const handleUpdatePrices = async () => {
        ...
        setIsUpdating(true);
        try {
            const response = await fetch('http://localhost:3000/api/watchlist/update-prices', {
                method: 'POST'
            });
            if (!response.ok) {
    ...
    const handleCleanup = async () => {
        try {
            const response = await fetch('http://localhost:3000/api/watchlist/cleanup', {
                method: 'POST'
            });
            if (!response.ok) {
